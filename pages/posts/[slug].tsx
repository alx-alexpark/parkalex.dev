...
const PostPage = ({ source, frontMatter, readingTime }: PostPageProps): JSX.Element => {
    ...
    return (
        <div style={{ backgroundColor: "black" }}>
            ...
            <Flex maxWidth="75vw" minHeight="67.5vh" marginLeft="10em" backgroundColor="white" padding="5em" flexDirection="column" gap="0.75em" fontSize="1.15em"><MDXRemote {...source} /></Flex>
            <Footer />
        </div>
    );
};
